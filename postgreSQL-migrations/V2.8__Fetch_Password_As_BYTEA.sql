DROP FUNCTION IF EXISTS "user"."find_user_hashed_password";
...
BEGIN
   ...
   IF v_hashed_password IS NULL THEN
      RETURN QUERY SELECT 'NOT FOUND'::TEXT, NULL;
   END IF;

   RETURN QUERY SELECT NULL, v_hashed_password::BYTEA;
EXCEPTION
   WHEN OTHERS THEN
      RETURN QUERY SELECT 'ERROR'::TEXT, NULL;
END;
$$ LANGUAGE plpgsql;